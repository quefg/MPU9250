...
# Labels for angles and position
angle_label = label(pos=vector(0, -2, 0), text="Angles: ")
position_label = label(pos=vector(0, -2.5, 0), text="Position: ")
...
def run_visualization():
    ...
    with SMBus(I2C_BUS) as bus:
        ...
        while True:
            ...
            # Update 3D visualization for orientation
            mpu_box.axis = vector(
